...
3: Navigate to /app/src/main/docker from the root directory. And enter the following command:
~~~~
docker-compose up -d
~~~~
You can now access the Vici app at http://127.0.0.1:8080/ and the eiffel-event-repository from 
