...
Windows PowerShell
~~~~
(./gradlew build) -and (java -jar .\build\libs\dummy-er-0.1.jar)
~~~~
Linux:
~~~~
./gradlew build && java -jar .\build\libs\dummy-er-0.1.jar
~~~~

## WIP: How to docker
- Dockerfile is found at eiffel-vici\dummy-er\src\main\docker\Dockerfile
...
~~~~
docker run -p 8081:8081 -t --name dummy-er ewahjon/dummy-er:0.1
~~~~
